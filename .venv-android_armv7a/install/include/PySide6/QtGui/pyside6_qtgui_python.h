...
enum [[deprecated]] : int {
    ...
    SBK_QFLAGS_QABSTRACTFILEICONPROVIDER_OPTION_IDX          = 146,
    ...
    SBK_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX                  = 148,
    ...
    SBK_QACCESSIBLESELECTIONINTERFACE_IDX                    = 38,
    SBK_QACCESSIBLESTATECHANGEEVENT_IDX                      = 40,
    SBK_QACCESSIBLETABLECELLINTERFACE_IDX                    = 42,
    SBK_QACCESSIBLETABLEMODELCHANGEEVENT_MODELCHANGETYPE_IDX = 46,
    SBK_QACCESSIBLETABLEMODELCHANGEEVENT_IDX                 = 44,
    SBK_QACCESSIBLETEXTCURSOREVENT_IDX                       = 48,
    SBK_QACCESSIBLETEXTINSERTEVENT_IDX                       = 50,
    SBK_QACCESSIBLETEXTINTERFACE_IDX                         = 52,
    SBK_QACCESSIBLETEXTREMOVEEVENT_IDX                       = 54,
    SBK_QACCESSIBLETEXTSELECTIONEVENT_IDX                    = 56,
    SBK_QACCESSIBLETEXTUPDATEEVENT_IDX                       = 58,
    SBK_QACCESSIBLEVALUECHANGEEVENT_IDX                      = 60,
    SBK_QACCESSIBLEVALUEINTERFACE_IDX                        = 62,
    SBK_QACTION_MENUROLE_IDX                                 = 68,
    SBK_QACTION_PRIORITY_IDX                                 = 70,
    SBK_QACTION_ACTIONEVENT_IDX                              = 66,
    SBK_QACTION_IDX                                          = 64,
    SBK_QACTIONEVENT_IDX                                     = 72,
    SBK_QACTIONGROUP_EXCLUSIONPOLICY_IDX                     = 76,
    SBK_QACTIONGROUP_IDX                                     = 74,
    SBK_QBACKINGSTORE_IDX                                    = 78,
    SBK_QBITMAP_IDX                                          = 80,
    SBK_QBRUSH_IDX                                           = 82,
    SBK_QCHILDWINDOWEVENT_IDX                                = 84,
    SBK_QCLIPBOARD_MODE_IDX                                  = 88,
    SBK_QCLIPBOARD_IDX                                       = 86,
    SBK_QCLOSEEVENT_IDX                                      = 90,
    SBK_QCOLOR_SPEC_IDX                                      = 96,
    SBK_QCOLOR_NAMEFORMAT_IDX                                = 94,
    SBK_QCOLOR_IDX                                           = 92,
    SBK_QTGUIQCOLORCONSTANTS_IDX                             = 98,
    SBK_QTGUIQCOLORCONSTANTS_SVG_IDX                         = 100,
    SBK_QCOLORSPACE_NAMEDCOLORSPACE_IDX                      = 104,
    SBK_QCOLORSPACE_PRIMARIES_IDX                            = 106,
    SBK_QCOLORSPACE_TRANSFERFUNCTION_IDX                     = 108,
    SBK_QCOLORSPACE_IDX                                      = 102,
    SBK_QCOLORTRANSFORM_IDX                                  = 110,
    SBK_QCONICALGRADIENT_IDX                                 = 112,
    SBK_QCONTEXTMENUEVENT_REASON_IDX                         = 116,
    SBK_QCONTEXTMENUEVENT_IDX                                = 114,
    SBK_QCURSOR_IDX                                          = 118,
    SBK_QDESKTOPSERVICES_IDX                                 = 120,
    SBK_QDOUBLEVALIDATOR_NOTATION_IDX                        = 124,
    SBK_QDOUBLEVALIDATOR_IDX                                 = 122,
    SBK_QDRAG_IDX                                            = 126,
    SBK_QDRAGENTEREVENT_IDX                                  = 128,
    SBK_QDRAGLEAVEEVENT_IDX                                  = 130,
    SBK_QDRAGMOVEEVENT_IDX                                   = 132,
    SBK_QDROPEVENT_IDX                                       = 134,
    SBK_QENTEREVENT_IDX                                      = 136,
    SBK_QEVENTPOINT_STATE_IDX                                = 140,
    SBK_QEVENTPOINT_IDX                                      = 138,
    SBK_QEXPOSEEVENT_IDX                                     = 142,
    SBK_QFILEOPENEVENT_IDX                                   = 144,
    SBK_QFOCUSEVENT_IDX                                      = 218,
    SBK_QFONT_STYLEHINT_IDX                                  = 230,
    SBK_QFONT_STYLESTRATEGY_IDX                              = 232,
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 942,
    SBK_QFONT_WEIGHT_IDX                                     = 236,
    SBK_QFONT_STYLE_IDX                                      = 228,
    SBK_QFONT_STRETCH_IDX                                    = 226,
    SBK_QFONT_CAPITALIZATION_IDX                             = 222,
    SBK_QFONT_SPACINGTYPE_IDX                                = 224,
    SBK_QFONT_IDX                                            = 220,
    SBK_QFONT_TAG_IDX                                        = 234,
    SBK_QFONTDATABASE_WRITINGSYSTEM_IDX                      = 242,
    SBK_QFONTDATABASE_SYSTEMFONT_IDX                         = 240,
    SBK_QFONTDATABASE_IDX                                    = 238,
    SBK_QFONTINFO_IDX                                        = 244,
    SBK_QFONTMETRICS_IDX                                     = 246,
    SBK_QFONTMETRICSF_IDX                                    = 248,
    SBK_QGLYPHRUN_GLYPHRUNFLAG_IDX                           = 252,
    SBK_QFLAGS_QGLYPHRUN_GLYPHRUNFLAG_IDX                    = 150,
    SBK_QGLYPHRUN_IDX                                        = 250,
    SBK_QGRADIENT_TYPE_IDX                                   = 264,
    SBK_QGRADIENT_SPREAD_IDX                                 = 262,
    SBK_QGRADIENT_COORDINATEMODE_IDX                         = 256,
    SBK_QGRADIENT_INTERPOLATIONMODE_IDX                      = 258,
    SBK_QGRADIENT_PRESET_IDX                                 = 260,
    SBK_QGRADIENT_IDX                                        = 254,
    SBK_QGUIAPPLICATION_IDX                                  = 266,
    SBK_QHELPEVENT_IDX                                       = 268,
    SBK_QHIDEEVENT_IDX                                       = 270,
    SBK_QHOVEREVENT_IDX                                      = 272,
    SBK_QICON_MODE_IDX                                       = 276,
    SBK_QICON_STATE_IDX                                      = 278,
    SBK_QICON_THEMEICON_IDX                                  = 280,
    SBK_QICON_IDX                                            = 274,
    SBK_QICONDRAGEVENT_IDX                                   = 282,
    SBK_QICONENGINE_ICONENGINEHOOK_IDX                       = 286,
    SBK_QICONENGINE_IDX                                      = 284,
    SBK_QICONENGINE_SCALEDPIXMAPARGUMENT_IDX                 = 288,
    SBK_QIMAGE_INVERTMODE_IDX                                = 294,
    SBK_QIMAGE_FORMAT_IDX                                    = 292,
    SBK_QIMAGE_IDX                                           = 290,
    SBK_QIMAGEIOHANDLER_IMAGEOPTION_IDX                      = 298,
    SBK_QIMAGEIOHANDLER_TRANSFORMATION_IDX                   = 300,
    SBK_QFLAGS_QIMAGEIOHANDLER_TRANSFORMATION_IDX            = 152,
    SBK_QIMAGEIOHANDLER_IDX                                  = 296,
    SBK_QIMAGEREADER_IMAGEREADERERROR_IDX                    = 304,
    SBK_QIMAGEREADER_IDX                                     = 302,
    SBK_QIMAGEWRITER_IMAGEWRITERERROR_IDX                    = 308,
    SBK_QIMAGEWRITER_IDX                                     = 306,
    SBK_QINPUTDEVICE_DEVICETYPE_IDX                          = 314,
    SBK_QFLAGS_QINPUTDEVICE_DEVICETYPE_IDX                   = 156,
    SBK_QINPUTDEVICE_CAPABILITY_IDX                          = 312,
    SBK_QFLAGS_QINPUTDEVICE_CAPABILITY_IDX                   = 154,
    SBK_QINPUTDEVICE_IDX                                     = 310,
    SBK_QINPUTEVENT_IDX                                      = 316,
    SBK_QINPUTMETHOD_ACTION_IDX                              = 320,
    SBK_QINPUTMETHOD_IDX                                     = 318,
    SBK_QINPUTMETHODEVENT_ATTRIBUTETYPE_IDX                  = 326,
    SBK_QINPUTMETHODEVENT_IDX                                = 322,
    SBK_QINPUTMETHODEVENT_ATTRIBUTE_IDX                      = 324,
    SBK_QINPUTMETHODQUERYEVENT_IDX                           = 328,
    SBK_QINTVALIDATOR_IDX                                    = 330,
    SBK_QKEYEVENT_IDX                                        = 332,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 340,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 336,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 338,
    SBK_QKEYSEQUENCE_IDX                                     = 334,
    SBK_QLINEARGRADIENT_IDX                                  = 342,
    SBK_QMATRIX2X2_IDX                                       = 344,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 344,
    SBK_QMATRIX2X3_IDX                                       = 346,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 346,
    SBK_QMATRIX2X4_IDX                                       = 348,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 348,
    SBK_QMATRIX3X2_IDX                                       = 350,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 350,
    SBK_QMATRIX3X3_IDX                                       = 352,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 352,
    SBK_QMATRIX3X4_IDX                                       = 354,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 354,
    SBK_QMATRIX4X2_IDX                                       = 356,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 356,
    SBK_QMATRIX4X3_IDX                                       = 358,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 358,
    SBK_QMATRIX4X4_FLAG_IDX                                  = 362,
    SBK_QFLAGS_QMATRIX4X4_FLAG_IDX                           = 158,
    SBK_QMATRIX4X4_IDX                                       = 360,
    SBK_QMOUSEEVENT_IDX                                      = 364,
    SBK_QMOVEEVENT_IDX                                       = 366,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 372,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 370,
    SBK_QMOVIE_IDX                                           = 368,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 374,
    SBK_QTGUIQNATIVEINTERFACE_IDX                            = 376,
    SBK_QOFFSCREENSURFACE_IDX                                = 382,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 386,
    SBK_QOPENGLCONTEXT_IDX                                   = 384,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 388,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 390,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 394,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 160,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 392,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 402,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 400,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 398,
    SBK_QPAGELAYOUT_IDX                                      = 396,
    SBK_QPAGERANGES_IDX                                      = 404,
    SBK_QPAGERANGES_RANGE_IDX                                = 406,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 410,
    SBK_QPAGESIZE_UNIT_IDX                                   = 414,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 412,
    SBK_QPAGESIZE_IDX                                        = 408,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 418,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 416,
    SBK_QPAINTDEVICE_PAINTDEVICEMETRIC_IDX                   = 422,
    SBK_QPAINTDEVICE_IDX                                     = 420,
    SBK_QPAINTDEVICEWINDOW_IDX                               = 424,
    SBK_QPAINTENGINE_PAINTENGINEFEATURE_IDX                  = 430,
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 164,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 428,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 162,
    SBK_QPAINTENGINE_POLYGONDRAWMODE_IDX                     = 432,
    SBK_QPAINTENGINE_TYPE_IDX                                = 434,
    SBK_QPAINTENGINE_IDX                                     = 426,
    SBK_QPAINTENGINESTATE_IDX                                = 436,
    SBK_QPAINTEVENT_IDX                                      = 438,
    SBK_QPAINTER_RENDERHINT_IDX                              = 448,
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 168,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 446,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 166,
    SBK_QPAINTER_COMPOSITIONMODE_IDX                         = 442,
    SBK_QPAINTER_IDX                                         = 440,
    SBK_QPAINTER_PIXMAPFRAGMENT_IDX                          = 444,
    SBK_QPAINTERPATH_ELEMENTTYPE_IDX                         = 454,
    SBK_QPAINTERPATH_IDX                                     = 450,
    SBK_QPAINTERPATH_ELEMENT_IDX                             = 452,
    SBK_QPAINTERPATHSTROKER_IDX                              = 456,
    SBK_QPALETTE_COLORGROUP_IDX                              = 460,
    SBK_QPALETTE_COLORROLE_IDX                               = 462,
    SBK_QPALETTE_IDX                                         = 458,
    SBK_QPDFWRITER_IDX                                       = 464,
    SBK_QPEN_IDX                                             = 466,
    SBK_QPICTURE_IDX                                         = 468,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 480,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 476,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 472,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 474,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 482,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 484,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 478,
    SBK_QPIXELFORMAT_IDX                                     = 470,
    SBK_QPIXMAP_IDX                                          = 486,
    SBK_QPIXMAPCACHE_IDX                                     = 488,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 490,
    SBK_QPLATFORMSURFACEEVENT_SURFACEEVENTTYPE_IDX           = 494,
    SBK_QPLATFORMSURFACEEVENT_IDX                            = 492,
    SBK_QPOINTEREVENT_IDX                                    = 496,
    SBK_QPOINTINGDEVICE_POINTERTYPE_IDX                      = 502,
    SBK_QFLAGS_QPOINTINGDEVICE_POINTERTYPE_IDX               = 170,
    SBK_QPOINTINGDEVICE_GRABTRANSITION_IDX                   = 500,
    SBK_QPOINTINGDEVICE_IDX                                  = 498,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 504,
    SBK_QPOLYGON_IDX                                         = 506,
    SBK_QPOLYGONF_IDX                                        = 508,
    SBK_QPYTEXTOBJECT_IDX                                    = 510,
    SBK_QQUATERNION_IDX                                      = 512,
    SBK_QRADIALGRADIENT_IDX                                  = 514,
    SBK_QRASTERWINDOW_IDX                                    = 516,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 520,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 522,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 172,
    SBK_QRAWFONT_IDX                                         = 518,
    SBK_QREGION_REGIONTYPE_IDX                               = 526,
    SBK_QREGION_IDX                                          = 524,
    SBK_QREGULAREXPRESSIONVALIDATOR_IDX                      = 528,
    SBK_QRESIZEEVENT_IDX                                     = 530,
    SBK_QRGBA64_IDX                                          = 532,
    SBK_QRHI_IMPLEMENTATION_IDX                              = 546,
    SBK_QRHI_FLAG_IDX                                        = 542,
    SBK_QFLAGS_QRHI_FLAG_IDX                                 = 178,
    SBK_QRHI_FRAMEOPRESULT_IDX                               = 544,
    SBK_QRHI_FEATURE_IDX                                     = 540,
    SBK_QRHI_BEGINFRAMEFLAG_IDX                              = 536,
    SBK_QFLAGS_QRHI_BEGINFRAMEFLAG_IDX                       = 174,
    SBK_QRHI_ENDFRAMEFLAG_IDX                                = 538,
    SBK_QFLAGS_QRHI_ENDFRAMEFLAG_IDX                         = 176,
    SBK_QRHI_RESOURCELIMIT_IDX                               = 548,
    SBK_QRHI_IDX                                             = 534,
    SBK_QRHIBUFFER_TYPE_IDX                                  = 552,
    SBK_QRHIBUFFER_USAGEFLAG_IDX                             = 554,
    SBK_QFLAGS_QRHIBUFFER_USAGEFLAG_IDX                      = 180,
    SBK_QRHIBUFFER_IDX                                       = 550,
    SBK_QRHICOLORATTACHMENT_IDX                              = 556,
    SBK_QRHICOMMANDBUFFER_INDEXFORMAT_IDX                    = 562,
    SBK_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX                  = 560,
    SBK_QFLAGS_QRHICOMMANDBUFFER_BEGINPASSFLAG_IDX           = 182,
    SBK_QRHICOMMANDBUFFER_IDX                                = 558,
    SBK_QRHICOMPUTEPIPELINE_FLAG_IDX                         = 566,
    SBK_QFLAGS_QRHICOMPUTEPIPELINE_FLAG_IDX                  = 184,
    SBK_QRHICOMPUTEPIPELINE_IDX                              = 564,
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 568,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 572,
    SBK_QRHIDRIVERINFO_IDX                                   = 570,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 574,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 576,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 590,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 188,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 602,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 588,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 592,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 584,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 186,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 580,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 582,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 586,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 596,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 594,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 578,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 598,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 600,
    SBK_QRHIINITPARAMS_IDX                                   = 604,
    SBK_QRHINATIVEHANDLES_IDX                                = 606,
    SBK_QRHINULLINITPARAMS_IDX                               = 608,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 610,
    SBK_QRHIREADBACKRESULT_IDX                               = 612,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 618,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 616,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 190,
    SBK_QRHIRENDERBUFFER_IDX                                 = 614,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 620,
    SBK_QRHIRENDERTARGET_IDX                                 = 622,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 626,
    SBK_QRHIRESOURCE_IDX                                     = 624,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 628,
    SBK_QRHISAMPLER_FILTER_IDX                               = 636,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 632,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 634,
    SBK_QRHISAMPLER_IDX                                      = 630,
    SBK_QRHISCISSOR_IDX                                      = 638,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 652,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 648,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 192,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 640,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 642,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 644,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 646,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 650,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 656,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 194,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 654,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 660,
    SBK_QRHISHADERSTAGE_IDX                                  = 658,
    SBK_QRHISTATS_IDX                                        = 662,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 666,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 196,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 668,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 670,
    SBK_QRHISWAPCHAIN_IDX                                    = 664,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 672,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 676,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 198,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 678,
    SBK_QRHITEXTURE_IDX                                      = 674,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 680,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 684,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 200,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 682,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 686,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 688,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 690,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 692,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 696,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 694,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 700,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 698,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 702,
    SBK_QRHIVIEWPORT_IDX                                     = 704,
    SBK_QSCREEN_IDX                                          = 706,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 710,
    SBK_QSCROLLEVENT_IDX                                     = 708,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 712,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 716,
    SBK_QSESSIONMANAGER_IDX                                  = 714,
    SBK_QSHADER_STAGE_IDX                                    = 724,
    SBK_QSHADER_SOURCE_IDX                                   = 722,
    SBK_QSHADER_VARIANT_IDX                                  = 726,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 720,
    SBK_QSHADER_IDX                                          = 718,
    SBK_QSHADERCODE_IDX                                      = 728,
    SBK_QSHADERKEY_IDX                                       = 730,
    SBK_QSHADERVERSION_FLAG_IDX                              = 734,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 202,
    SBK_QSHADERVERSION_IDX                                   = 732,
    SBK_QSHORTCUT_IDX                                        = 736,
    SBK_QSHORTCUTEVENT_IDX                                   = 738,
    SBK_QSHOWEVENT_IDX                                       = 740,
    SBK_QSINGLEPOINTEVENT_IDX                                = 742,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 746,
    SBK_QSTANDARDITEM_IDX                                    = 744,
    SBK_QSTANDARDITEMMODEL_IDX                               = 748,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 752,
    SBK_QSTATICTEXT_IDX                                      = 750,
    SBK_QSTATUSTIPEVENT_IDX                                  = 754,
    SBK_QSTYLEHINTS_IDX                                      = 756,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 760,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 762,
    SBK_QSURFACE_IDX                                         = 758,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 768,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 204,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 774,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 772,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 770,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 766,
    SBK_QSURFACEFORMAT_IDX                                   = 764,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 776,
    SBK_QTABLETEVENT_IDX                                     = 778,
    SBK_QTEXTBLOCK_IDX                                       = 780,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 782,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 944,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 786,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 784,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 788,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 790,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 798,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 796,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 794,
    SBK_QTEXTCHARFORMAT_IDX                                  = 792,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 802,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 804,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 806,
    SBK_QTEXTCURSOR_IDX                                      = 800,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 814,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 812,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 208,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 810,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 206,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 816,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 818,
    SBK_QTEXTDOCUMENT_IDX                                    = 808,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 820,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 822,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 826,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 832,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 828,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 830,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 210,
    SBK_QTEXTFORMAT_IDX                                      = 824,
    SBK_QTEXTFRAGMENT_IDX                                    = 834,
    SBK_QTEXTFRAME_IDX                                       = 836,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 838,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 844,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 842,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 840,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 846,
    SBK_QTEXTINLINEOBJECT_IDX                                = 848,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 852,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 212,
    SBK_QTEXTITEM_IDX                                        = 850,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 860,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 214,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 856,
    SBK_QTEXTLAYOUT_IDX                                      = 854,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 858,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 864,
    SBK_QTEXTLENGTH_IDX                                      = 862,
    SBK_QTEXTLINE_EDGE_IDX                                   = 870,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 868,
    SBK_QTEXTLINE_IDX                                        = 866,
    SBK_QTEXTLIST_IDX                                        = 872,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 876,
    SBK_QTEXTLISTFORMAT_IDX                                  = 874,
    SBK_QTEXTOBJECT_IDX                                      = 878,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 880,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 888,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 890,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 884,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 216,
    SBK_QTEXTOPTION_IDX                                      = 882,
    SBK_QTEXTOPTION_TAB_IDX                                  = 886,
    SBK_QTEXTTABLE_IDX                                       = 892,
    SBK_QTEXTTABLECELL_IDX                                   = 894,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 896,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 898,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 900,
    SBK_QTOUCHEVENT_IDX                                      = 902,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 906,
    SBK_QTRANSFORM_IDX                                       = 904,
    SBK_QUNDOCOMMAND_IDX                                     = 908,
    SBK_QUNDOGROUP_IDX                                       = 910,
    SBK_QUNDOSTACK_IDX                                       = 912,
    SBK_QVALIDATOR_STATE_IDX                                 = 916,
    SBK_QVALIDATOR_IDX                                       = 914,
    SBK_QVECTOR2D_IDX                                        = 918,
    SBK_QVECTOR3D_IDX                                        = 920,
    SBK_QVECTOR4D_IDX                                        = 922,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 924,
    SBK_QWHEELEVENT_IDX                                      = 926,
    SBK_QWINDOW_VISIBILITY_IDX                               = 932,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 930,
    SBK_QWINDOW_IDX                                          = 928,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 934,
    SBK_QTGUIQT_IDX                                          = 936,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 940,
    SBK_QTGUI_IDX_COUNT                                      = 946,
};
...
enum : int {
    ...
    SBK_QFlags_QAbstractFileIconProvider_Option_IDX          = 73,
    SBK_QAbstractFileIconProvider_IDX                        = 0,
    ...
    SBK_QFlags_QAccessible_RelationFlag_IDX                  = 74,
    ...
    SBK_QAccessibleSelectionInterface_IDX                    = 19,
    SBK_QAccessibleStateChangeEvent_IDX                      = 20,
    SBK_QAccessibleTableCellInterface_IDX                    = 21,
    SBK_QAccessibleTableModelChangeEvent_ModelChangeType_IDX = 23,
    SBK_QAccessibleTableModelChangeEvent_IDX                 = 22,
    SBK_QAccessibleTextCursorEvent_IDX                       = 24,
    SBK_QAccessibleTextInsertEvent_IDX                       = 25,
    SBK_QAccessibleTextInterface_IDX                         = 26,
    SBK_QAccessibleTextRemoveEvent_IDX                       = 27,
    SBK_QAccessibleTextSelectionEvent_IDX                    = 28,
    SBK_QAccessibleTextUpdateEvent_IDX                       = 29,
    SBK_QAccessibleValueChangeEvent_IDX                      = 30,
    SBK_QAccessibleValueInterface_IDX                        = 31,
    SBK_QAction_MenuRole_IDX                                 = 34,
    SBK_QAction_Priority_IDX                                 = 35,
    SBK_QAction_ActionEvent_IDX                              = 33,
    SBK_QAction_IDX                                          = 32,
    SBK_QActionEvent_IDX                                     = 36,
    SBK_QActionGroup_ExclusionPolicy_IDX                     = 38,
    SBK_QActionGroup_IDX                                     = 37,
    SBK_QBackingStore_IDX                                    = 39,
    SBK_QBitmap_IDX                                          = 40,
    SBK_QBrush_IDX                                           = 41,
    SBK_QChildWindowEvent_IDX                                = 42,
    SBK_QClipboard_Mode_IDX                                  = 44,
    SBK_QClipboard_IDX                                       = 43,
    SBK_QCloseEvent_IDX                                      = 45,
    SBK_QColor_Spec_IDX                                      = 48,
    SBK_QColor_NameFormat_IDX                                = 47,
    SBK_QColor_IDX                                           = 46,
    SBK_QtGuiQColorConstants_IDX                             = 49,
    SBK_QtGuiQColorConstants_Svg_IDX                         = 50,
    SBK_QColorSpace_NamedColorSpace_IDX                      = 52,
    SBK_QColorSpace_Primaries_IDX                            = 53,
    SBK_QColorSpace_TransferFunction_IDX                     = 54,
    SBK_QColorSpace_IDX                                      = 51,
    SBK_QColorTransform_IDX                                  = 55,
    SBK_QConicalGradient_IDX                                 = 56,
    SBK_QContextMenuEvent_Reason_IDX                         = 58,
    SBK_QContextMenuEvent_IDX                                = 57,
    SBK_QCursor_IDX                                          = 59,
    SBK_QDesktopServices_IDX                                 = 60,
    SBK_QDoubleValidator_Notation_IDX                        = 62,
    SBK_QDoubleValidator_IDX                                 = 61,
    SBK_QDrag_IDX                                            = 63,
    SBK_QDragEnterEvent_IDX                                  = 64,
    SBK_QDragLeaveEvent_IDX                                  = 65,
    SBK_QDragMoveEvent_IDX                                   = 66,
    SBK_QDropEvent_IDX                                       = 67,
    SBK_QEnterEvent_IDX                                      = 68,
    SBK_QEventPoint_State_IDX                                = 70,
    SBK_QEventPoint_IDX                                      = 69,
    SBK_QExposeEvent_IDX                                     = 71,
    SBK_QFileOpenEvent_IDX                                   = 72,
    SBK_QFocusEvent_IDX                                      = 109,
    SBK_QFont_StyleHint_IDX                                  = 115,
    SBK_QFont_StyleStrategy_IDX                              = 116,
    SBK_QFont_HintingPreference_IDX                          = 471,
    SBK_QFont_Weight_IDX                                     = 118,
    SBK_QFont_Style_IDX                                      = 114,
    SBK_QFont_Stretch_IDX                                    = 113,
    SBK_QFont_Capitalization_IDX                             = 111,
    SBK_QFont_SpacingType_IDX                                = 112,
    SBK_QFont_IDX                                            = 110,
    SBK_QFont_Tag_IDX                                        = 117,
    SBK_QFontDatabase_WritingSystem_IDX                      = 121,
    SBK_QFontDatabase_SystemFont_IDX                         = 120,
    SBK_QFontDatabase_IDX                                    = 119,
    SBK_QFontInfo_IDX                                        = 122,
    SBK_QFontMetrics_IDX                                     = 123,
    SBK_QFontMetricsF_IDX                                    = 124,
    SBK_QGlyphRun_GlyphRunFlag_IDX                           = 126,
    SBK_QFlags_QGlyphRun_GlyphRunFlag_IDX                    = 75,
    SBK_QGlyphRun_IDX                                        = 125,
    SBK_QGradient_Type_IDX                                   = 132,
    SBK_QGradient_Spread_IDX                                 = 131,
    SBK_QGradient_CoordinateMode_IDX                         = 128,
    SBK_QGradient_InterpolationMode_IDX                      = 129,
    SBK_QGradient_Preset_IDX                                 = 130,
    SBK_QGradient_IDX                                        = 127,
    SBK_QGuiApplication_IDX                                  = 133,
    SBK_QHelpEvent_IDX                                       = 134,
    SBK_QHideEvent_IDX                                       = 135,
    SBK_QHoverEvent_IDX                                      = 136,
    SBK_QIcon_Mode_IDX                                       = 138,
    SBK_QIcon_State_IDX                                      = 139,
    SBK_QIcon_ThemeIcon_IDX                                  = 140,
    SBK_QIcon_IDX                                            = 137,
    SBK_QIconDragEvent_IDX                                   = 141,
    SBK_QIconEngine_IconEngineHook_IDX                       = 143,
    SBK_QIconEngine_IDX                                      = 142,
    SBK_QIconEngine_ScaledPixmapArgument_IDX                 = 144,
    SBK_QImage_InvertMode_IDX                                = 147,
    SBK_QImage_Format_IDX                                    = 146,
    SBK_QImage_IDX                                           = 145,
    SBK_QImageIOHandler_ImageOption_IDX                      = 149,
    SBK_QImageIOHandler_Transformation_IDX                   = 150,
    SBK_QFlags_QImageIOHandler_Transformation_IDX            = 76,
    SBK_QImageIOHandler_IDX                                  = 148,
    SBK_QImageReader_ImageReaderError_IDX                    = 152,
    SBK_QImageReader_IDX                                     = 151,
    SBK_QImageWriter_ImageWriterError_IDX                    = 154,
    SBK_QImageWriter_IDX                                     = 153,
    SBK_QInputDevice_DeviceType_IDX                          = 157,
    SBK_QFlags_QInputDevice_DeviceType_IDX                   = 78,
    SBK_QInputDevice_Capability_IDX                          = 156,
    SBK_QFlags_QInputDevice_Capability_IDX                   = 77,
    SBK_QInputDevice_IDX                                     = 155,
    SBK_QInputEvent_IDX                                      = 158,
    SBK_QInputMethod_Action_IDX                              = 160,
    SBK_QInputMethod_IDX                                     = 159,
    SBK_QInputMethodEvent_AttributeType_IDX                  = 163,
    SBK_QInputMethodEvent_IDX                                = 161,
    SBK_QInputMethodEvent_Attribute_IDX                      = 162,
    SBK_QInputMethodQueryEvent_IDX                           = 164,
    SBK_QIntValidator_IDX                                    = 165,
    SBK_QKeyEvent_IDX                                        = 166,
    SBK_QKeySequence_StandardKey_IDX                         = 170,
    SBK_QKeySequence_SequenceFormat_IDX                      = 168,
    SBK_QKeySequence_SequenceMatch_IDX                       = 169,
    SBK_QKeySequence_IDX                                     = 167,
    SBK_QLinearGradient_IDX                                  = 171,
    SBK_QMatrix2x2_IDX                                       = 172,
    SBK_QGenericMatrix_2_2_float_IDX                         = 172,
    SBK_QMatrix2x3_IDX                                       = 173,
    SBK_QGenericMatrix_2_3_float_IDX                         = 173,
    SBK_QMatrix2x4_IDX                                       = 174,
    SBK_QGenericMatrix_2_4_float_IDX                         = 174,
    SBK_QMatrix3x2_IDX                                       = 175,
    SBK_QGenericMatrix_3_2_float_IDX                         = 175,
    SBK_QMatrix3x3_IDX                                       = 176,
    SBK_QGenericMatrix_3_3_float_IDX                         = 176,
    SBK_QMatrix3x4_IDX                                       = 177,
    SBK_QGenericMatrix_3_4_float_IDX                         = 177,
    SBK_QMatrix4x2_IDX                                       = 178,
    SBK_QGenericMatrix_4_2_float_IDX                         = 178,
    SBK_QMatrix4x3_IDX                                       = 179,
    SBK_QGenericMatrix_4_3_float_IDX                         = 179,
    SBK_QMatrix4x4_Flag_IDX                                  = 181,
    SBK_QFlags_QMatrix4x4_Flag_IDX                           = 79,
    SBK_QMatrix4x4_IDX                                       = 180,
    SBK_QMouseEvent_IDX                                      = 182,
    SBK_QMoveEvent_IDX                                       = 183,
    SBK_QMovie_MovieState_IDX                                = 186,
    SBK_QMovie_CacheMode_IDX                                 = 185,
    SBK_QMovie_IDX                                           = 184,
    SBK_QNativeGestureEvent_IDX                              = 187,
    SBK_QtGuiQNativeInterface_IDX                            = 188,
    SBK_QOffscreenSurface_IDX                                = 191,
    SBK_QOpenGLContext_OpenGLModuleType_IDX                  = 193,
    SBK_QOpenGLContext_IDX                                   = 192,
    SBK_QOpenGLContextGroup_IDX                              = 194,
    SBK_QOpenGLExtraFunctions_IDX                            = 195,
    SBK_QOpenGLFunctions_OpenGLFeature_IDX                   = 197,
    SBK_QFlags_QOpenGLFunctions_OpenGLFeature_IDX            = 80,
    SBK_QOpenGLFunctions_IDX                                 = 196,
    SBK_QPageLayout_Unit_IDX                                 = 201,
    SBK_QPageLayout_Orientation_IDX                          = 200,
    SBK_QPageLayout_Mode_IDX                                 = 199,
    SBK_QPageLayout_IDX                                      = 198,
    SBK_QPageRanges_IDX                                      = 202,
    SBK_QPageRanges_Range_IDX                                = 203,
    SBK_QPageSize_PageSizeId_IDX                             = 205,
    SBK_QPageSize_Unit_IDX                                   = 207,
    SBK_QPageSize_SizeMatchPolicy_IDX                        = 206,
    SBK_QPageSize_IDX                                        = 204,
    SBK_QPagedPaintDevice_PdfVersion_IDX                     = 209,
    SBK_QPagedPaintDevice_IDX                                = 208,
    SBK_QPaintDevice_PaintDeviceMetric_IDX                   = 211,
    SBK_QPaintDevice_IDX                                     = 210,
    SBK_QPaintDeviceWindow_IDX                               = 212,
    SBK_QPaintEngine_PaintEngineFeature_IDX                  = 215,
    SBK_QFlags_QPaintEngine_PaintEngineFeature_IDX           = 82,
    SBK_QPaintEngine_DirtyFlag_IDX                           = 214,
    SBK_QFlags_QPaintEngine_DirtyFlag_IDX                    = 81,
    SBK_QPaintEngine_PolygonDrawMode_IDX                     = 216,
    SBK_QPaintEngine_Type_IDX                                = 217,
    SBK_QPaintEngine_IDX                                     = 213,
    SBK_QPaintEngineState_IDX                                = 218,
    SBK_QPaintEvent_IDX                                      = 219,
    SBK_QPainter_RenderHint_IDX                              = 224,
    SBK_QFlags_QPainter_RenderHint_IDX                       = 84,
    SBK_QPainter_PixmapFragmentHint_IDX                      = 223,
    SBK_QFlags_QPainter_PixmapFragmentHint_IDX               = 83,
    SBK_QPainter_CompositionMode_IDX                         = 221,
    SBK_QPainter_IDX                                         = 220,
    SBK_QPainter_PixmapFragment_IDX                          = 222,
    SBK_QPainterPath_ElementType_IDX                         = 227,
    SBK_QPainterPath_IDX                                     = 225,
    SBK_QPainterPath_Element_IDX                             = 226,
    SBK_QPainterPathStroker_IDX                              = 228,
    SBK_QPalette_ColorGroup_IDX                              = 230,
    SBK_QPalette_ColorRole_IDX                               = 231,
    SBK_QPalette_IDX                                         = 229,
    SBK_QPdfWriter_IDX                                       = 232,
    SBK_QPen_IDX                                             = 233,
    SBK_QPicture_IDX                                         = 234,
    SBK_QPixelFormat_ColorModel_IDX                          = 240,
    SBK_QPixelFormat_AlphaUsage_IDX                          = 238,
    SBK_QPixelFormat_AlphaPosition_IDX                       = 236,
    SBK_QPixelFormat_AlphaPremultiplied_IDX                  = 237,
    SBK_QPixelFormat_TypeInterpretation_IDX                  = 241,
    SBK_QPixelFormat_YUVLayout_IDX                           = 242,
    SBK_QPixelFormat_ByteOrder_IDX                           = 239,
    SBK_QPixelFormat_IDX                                     = 235,
    SBK_QPixmap_IDX                                          = 243,
    SBK_QPixmapCache_IDX                                     = 244,
    SBK_QPixmapCache_Key_IDX                                 = 245,
    SBK_QPlatformSurfaceEvent_SurfaceEventType_IDX           = 247,
    SBK_QPlatformSurfaceEvent_IDX                            = 246,
    SBK_QPointerEvent_IDX                                    = 248,
    SBK_QPointingDevice_PointerType_IDX                      = 251,
    SBK_QFlags_QPointingDevice_PointerType_IDX               = 85,
    SBK_QPointingDevice_GrabTransition_IDX                   = 250,
    SBK_QPointingDevice_IDX                                  = 249,
    SBK_QPointingDeviceUniqueId_IDX                          = 252,
    SBK_QPolygon_IDX                                         = 253,
    SBK_QPolygonF_IDX                                        = 254,
    SBK_QPyTextObject_IDX                                    = 255,
    SBK_QQuaternion_IDX                                      = 256,
    SBK_QRadialGradient_IDX                                  = 257,
    SBK_QRasterWindow_IDX                                    = 258,
    SBK_QRawFont_AntialiasingType_IDX                        = 260,
    SBK_QRawFont_LayoutFlag_IDX                              = 261,
    SBK_QFlags_QRawFont_LayoutFlag_IDX                       = 86,
    SBK_QRawFont_IDX                                         = 259,
    SBK_QRegion_RegionType_IDX                               = 263,
    SBK_QRegion_IDX                                          = 262,
    SBK_QRegularExpressionValidator_IDX                      = 264,
    SBK_QResizeEvent_IDX                                     = 265,
    SBK_QRgba64_IDX                                          = 266,
    SBK_QRhi_Implementation_IDX                              = 273,
    SBK_QRhi_Flag_IDX                                        = 271,
    SBK_QFlags_QRhi_Flag_IDX                                 = 89,
    SBK_QRhi_FrameOpResult_IDX                               = 272,
    SBK_QRhi_Feature_IDX                                     = 270,
    SBK_QRhi_BeginFrameFlag_IDX                              = 268,
    SBK_QFlags_QRhi_BeginFrameFlag_IDX                       = 87,
    SBK_QRhi_EndFrameFlag_IDX                                = 269,
    SBK_QFlags_QRhi_EndFrameFlag_IDX                         = 88,
    SBK_QRhi_ResourceLimit_IDX                               = 274,
    SBK_QRhi_IDX                                             = 267,
    SBK_QRhiBuffer_Type_IDX                                  = 276,
    SBK_QRhiBuffer_UsageFlag_IDX                             = 277,
    SBK_QFlags_QRhiBuffer_UsageFlag_IDX                      = 90,
    SBK_QRhiBuffer_IDX                                       = 275,
    SBK_QRhiColorAttachment_IDX                              = 278,
    SBK_QRhiCommandBuffer_IndexFormat_IDX                    = 281,
    SBK_QRhiCommandBuffer_BeginPassFlag_IDX                  = 280,
    SBK_QFlags_QRhiCommandBuffer_BeginPassFlag_IDX           = 91,
    SBK_QRhiCommandBuffer_IDX                                = 279,
    SBK_QRhiComputePipeline_Flag_IDX                         = 283,
    SBK_QFlags_QRhiComputePipeline_Flag_IDX                  = 92,
    SBK_QRhiComputePipeline_IDX                              = 282,
    SBK_QRhiDepthStencilClearValue_IDX                       = 284,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 286,
    SBK_QRhiDriverInfo_IDX                                   = 285,
    SBK_QRhiGles2InitParams_IDX                              = 287,
    SBK_QRhiGles2NativeHandles_IDX                           = 288,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 295,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 94,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 301,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 294,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 296,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 292,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 93,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 290,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 291,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 293,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 298,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 297,
    SBK_QRhiGraphicsPipeline_IDX                             = 289,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 299,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 300,
    SBK_QRhiInitParams_IDX                                   = 302,
    SBK_QRhiNativeHandles_IDX                                = 303,
    SBK_QRhiNullInitParams_IDX                               = 304,
    SBK_QRhiReadbackDescription_IDX                          = 305,
    SBK_QRhiReadbackResult_IDX                               = 306,
    SBK_QRhiRenderBuffer_Type_IDX                            = 309,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 308,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 95,
    SBK_QRhiRenderBuffer_IDX                                 = 307,
    SBK_QRhiRenderPassDescriptor_IDX                         = 310,
    SBK_QRhiRenderTarget_IDX                                 = 311,
    SBK_QRhiResource_Type_IDX                                = 313,
    SBK_QRhiResource_IDX                                     = 312,
    SBK_QRhiResourceUpdateBatch_IDX                          = 314,
    SBK_QRhiSampler_Filter_IDX                               = 318,
    SBK_QRhiSampler_AddressMode_IDX                          = 316,
    SBK_QRhiSampler_CompareOp_IDX                            = 317,
    SBK_QRhiSampler_IDX                                      = 315,
    SBK_QRhiScissor_IDX                                      = 319,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 326,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 324,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 96,
    SBK_QRhiShaderResourceBinding_IDX                        = 320,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 321,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 322,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 323,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 325,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 328,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 97,
    SBK_QRhiShaderResourceBindings_IDX                       = 327,
    SBK_QRhiShaderStage_Type_IDX                             = 330,
    SBK_QRhiShaderStage_IDX                                  = 329,
    SBK_QRhiStats_IDX                                        = 331,
    SBK_QRhiSwapChain_Flag_IDX                               = 333,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 98,
    SBK_QRhiSwapChain_Format_IDX                             = 334,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 335,
    SBK_QRhiSwapChain_IDX                                    = 332,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 336,
    SBK_QRhiTexture_Flag_IDX                                 = 338,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 99,
    SBK_QRhiTexture_Format_IDX                               = 339,
    SBK_QRhiTexture_IDX                                      = 337,
    SBK_QRhiTextureCopyDescription_IDX                       = 340,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 342,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 100,
    SBK_QRhiTextureRenderTarget_IDX                          = 341,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 343,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 344,
    SBK_QRhiTextureUploadDescription_IDX                     = 345,
    SBK_QRhiTextureUploadEntry_IDX                           = 346,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 348,
    SBK_QRhiVertexInputAttribute_IDX                         = 347,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 350,
    SBK_QRhiVertexInputBinding_IDX                           = 349,
    SBK_QRhiVertexInputLayout_IDX                            = 351,
    SBK_QRhiViewport_IDX                                     = 352,
    SBK_QScreen_IDX                                          = 353,
    SBK_QScrollEvent_ScrollState_IDX                         = 355,
    SBK_QScrollEvent_IDX                                     = 354,
    SBK_QScrollPrepareEvent_IDX                              = 356,
    SBK_QSessionManager_RestartHint_IDX                      = 358,
    SBK_QSessionManager_IDX                                  = 357,
    SBK_QShader_Stage_IDX                                    = 362,
    SBK_QShader_Source_IDX                                   = 361,
    SBK_QShader_Variant_IDX                                  = 363,
    SBK_QShader_SerializedFormatVersion_IDX                  = 360,
    SBK_QShader_IDX                                          = 359,
    SBK_QShaderCode_IDX                                      = 364,
    SBK_QShaderKey_IDX                                       = 365,
    SBK_QShaderVersion_Flag_IDX                              = 367,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 101,
    SBK_QShaderVersion_IDX                                   = 366,
    SBK_QShortcut_IDX                                        = 368,
    SBK_QShortcutEvent_IDX                                   = 369,
    SBK_QShowEvent_IDX                                       = 370,
    SBK_QSinglePointEvent_IDX                                = 371,
    SBK_QStandardItem_ItemType_IDX                           = 373,
    SBK_QStandardItem_IDX                                    = 372,
    SBK_QStandardItemModel_IDX                               = 374,
    SBK_QStaticText_PerformanceHint_IDX                      = 376,
    SBK_QStaticText_IDX                                      = 375,
    SBK_QStatusTipEvent_IDX                                  = 377,
    SBK_QStyleHints_IDX                                      = 378,
    SBK_QSurface_SurfaceClass_IDX                            = 380,
    SBK_QSurface_SurfaceType_IDX                             = 381,
    SBK_QSurface_IDX                                         = 379,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 384,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 102,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 387,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 386,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 385,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 383,
    SBK_QSurfaceFormat_IDX                                   = 382,
    SBK_QSyntaxHighlighter_IDX                               = 388,
    SBK_QTabletEvent_IDX                                     = 389,
    SBK_QTextBlock_IDX                                       = 390,
    SBK_QTextBlock_iterator_IDX                              = 391,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 472,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 393,
    SBK_QTextBlockFormat_IDX                                 = 392,
    SBK_QTextBlockGroup_IDX                                  = 394,
    SBK_QTextBlockUserData_IDX                               = 395,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 399,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 398,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 397,
    SBK_QTextCharFormat_IDX                                  = 396,
    SBK_QTextCursor_MoveMode_IDX                             = 401,
    SBK_QTextCursor_MoveOperation_IDX                        = 402,
    SBK_QTextCursor_SelectionType_IDX                        = 403,
    SBK_QTextCursor_IDX                                      = 400,
    SBK_QTextDocument_MetaInformation_IDX                    = 407,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 406,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 104,
    SBK_QTextDocument_FindFlag_IDX                           = 405,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 103,
    SBK_QTextDocument_ResourceType_IDX                       = 408,
    SBK_QTextDocument_Stacks_IDX                             = 409,
    SBK_QTextDocument_IDX                                    = 404,
    SBK_QTextDocumentFragment_IDX                            = 410,
    SBK_QTextDocumentWriter_IDX                              = 411,
    SBK_QTextFormat_FormatType_IDX                           = 413,
    SBK_QTextFormat_Property_IDX                             = 416,
    SBK_QTextFormat_ObjectTypes_IDX                          = 414,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 415,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 105,
    SBK_QTextFormat_IDX                                      = 412,
    SBK_QTextFragment_IDX                                    = 417,
    SBK_QTextFrame_IDX                                       = 418,
    SBK_QTextFrame_iterator_IDX                              = 419,
    SBK_QTextFrameFormat_Position_IDX                        = 422,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 421,
    SBK_QTextFrameFormat_IDX                                 = 420,
    SBK_QTextImageFormat_IDX                                 = 423,
    SBK_QTextInlineObject_IDX                                = 424,
    SBK_QTextItem_RenderFlag_IDX                             = 426,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 106,
    SBK_QTextItem_IDX                                        = 425,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 430,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 107,
    SBK_QTextLayout_CursorMode_IDX                           = 428,
    SBK_QTextLayout_IDX                                      = 427,
    SBK_QTextLayout_FormatRange_IDX                          = 429,
    SBK_QTextLength_Type_IDX                                 = 432,
    SBK_QTextLength_IDX                                      = 431,
    SBK_QTextLine_Edge_IDX                                   = 435,
    SBK_QTextLine_CursorPosition_IDX                         = 434,
    SBK_QTextLine_IDX                                        = 433,
    SBK_QTextList_IDX                                        = 436,
    SBK_QTextListFormat_Style_IDX                            = 438,
    SBK_QTextListFormat_IDX                                  = 437,
    SBK_QTextObject_IDX                                      = 439,
    SBK_QTextObjectInterface_IDX                             = 440,
    SBK_QTextOption_TabType_IDX                              = 444,
    SBK_QTextOption_WrapMode_IDX                             = 445,
    SBK_QTextOption_Flag_IDX                                 = 442,
    SBK_QFlags_QTextOption_Flag_IDX                          = 108,
    SBK_QTextOption_IDX                                      = 441,
    SBK_QTextOption_Tab_IDX                                  = 443,
    SBK_QTextTable_IDX                                       = 446,
    SBK_QTextTableCell_IDX                                   = 447,
    SBK_QTextTableCellFormat_IDX                             = 448,
    SBK_QTextTableFormat_IDX                                 = 449,
    SBK_QToolBarChangeEvent_IDX                              = 450,
    SBK_QTouchEvent_IDX                                      = 451,
    SBK_QTransform_TransformationType_IDX                    = 453,
    SBK_QTransform_IDX                                       = 452,
    SBK_QUndoCommand_IDX                                     = 454,
    SBK_QUndoGroup_IDX                                       = 455,
    SBK_QUndoStack_IDX                                       = 456,
    SBK_QValidator_State_IDX                                 = 458,
    SBK_QValidator_IDX                                       = 457,
    SBK_QVector2D_IDX                                        = 459,
    SBK_QVector3D_IDX                                        = 460,
    SBK_QVector4D_IDX                                        = 461,
    SBK_QWhatsThisClickedEvent_IDX                           = 462,
    SBK_QWheelEvent_IDX                                      = 463,
    SBK_QWindow_Visibility_IDX                               = 466,
    SBK_QWindow_AncestorMode_IDX                             = 465,
    SBK_QWindow_IDX                                          = 464,
    SBK_QWindowStateChangeEvent_IDX                          = 467,
    SBK_QtGuiQt_IDX                                          = 468,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 470,
    SBK_QtGui_IDX_COUNT                                      = 473,
};
