...
enum [[deprecated]] : int {
    ...
    SBK_QOPENGLFUNCTIONS_ES2_IDX                             = 96,
    SBK_QOPENGLPAINTDEVICE_IDX                               = 98,
    SBK_QOPENGLPIXELTRANSFEROPTIONS_IDX                      = 100,
    SBK_QOPENGLSHADER_SHADERTYPEBIT_IDX                      = 104,
    SBK_QFLAGS_QOPENGLSHADER_SHADERTYPEBIT_IDX               = 10,
    SBK_QOPENGLSHADER_IDX                                    = 102,
    SBK_QOPENGLSHADERPROGRAM_IDX                             = 106,
    SBK_QOPENGLTEXTURE_TARGET_IDX                            = 136,
    SBK_QOPENGLTEXTURE_BINDINGTARGET_IDX                     = 110,
    SBK_QOPENGLTEXTURE_MIPMAPGENERATION_IDX                  = 126,
    SBK_QOPENGLTEXTURE_TEXTUREUNITRESET_IDX                  = 142,
    SBK_QOPENGLTEXTURE_TEXTUREFORMAT_IDX                     = 138,
    SBK_QOPENGLTEXTURE_TEXTUREFORMATCLASS_IDX                = 140,
    SBK_QOPENGLTEXTURE_CUBEMAPFACE_IDX                       = 118,
    SBK_QOPENGLTEXTURE_PIXELFORMAT_IDX                       = 128,
    SBK_QOPENGLTEXTURE_PIXELTYPE_IDX                         = 130,
    SBK_QOPENGLTEXTURE_SWIZZLECOMPONENT_IDX                  = 132,
    SBK_QOPENGLTEXTURE_SWIZZLEVALUE_IDX                      = 134,
    SBK_QOPENGLTEXTURE_WRAPMODE_IDX                          = 144,
    SBK_QOPENGLTEXTURE_COORDINATEDIRECTION_IDX               = 116,
    SBK_QOPENGLTEXTURE_FEATURE_IDX                           = 122,
    SBK_QFLAGS_QOPENGLTEXTURE_FEATURE_IDX                    = 12,
    SBK_QOPENGLTEXTURE_DEPTHSTENCILMODE_IDX                  = 120,
    SBK_QOPENGLTEXTURE_COMPARISONFUNCTION_IDX                = 112,
    SBK_QOPENGLTEXTURE_COMPARISONMODE_IDX                    = 114,
    SBK_QOPENGLTEXTURE_FILTER_IDX                            = 124,
    SBK_QOPENGLTEXTURE_IDX                                   = 108,
    SBK_QOPENGLTEXTUREBLITTER_ORIGIN_IDX                     = 148,
    SBK_QOPENGLTEXTUREBLITTER_IDX                            = 146,
    SBK_QOPENGLVERSIONPROFILE_IDX                            = 150,
    SBK_QOPENGLVERTEXARRAYOBJECT_IDX                         = 152,
    SBK_QOPENGLVERTEXARRAYOBJECT_BINDER_IDX                  = 154,
    SBK_QOPENGLWINDOW_UPDATEBEHAVIOR_IDX                     = 158,
    SBK_QOPENGLWINDOW_IDX                                    = 156,
    SBK_QTOPENGL_IDX_COUNT                                   = 160,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTOPENGL_QLIST_FLOAT_IDX                             = 16, // QList<float>
    SBK_QTOPENGL_QLIST_QOPENGLSHADERPTR_IDX                  = 18, // QList<QOpenGLShader*>
    SBK_QTOPENGL_QLIST_QOPENGLDEBUGMESSAGE_IDX               = 20, // QList<QOpenGLDebugMessage>
    SBK_QTOPENGL_QLIST_QVARIANT_IDX                          = 22, // QList<QVariant>
    SBK_QTOPENGL_QLIST_QSTRING_IDX                           = 24, // QList<QString>
    SBK_QTOPENGL_QMAP_QSTRING_QVARIANT_IDX                   = 26, // QMap<QString,QVariant>
    SBK_QTOPENGL_CONVERTERS_IDX_COUNT                        = 28,
};
